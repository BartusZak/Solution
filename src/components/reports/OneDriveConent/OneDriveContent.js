...
import {
    authOneDriveACreator, sendCodeToGetTokenACreator, createFolderACreator,
                        ...
                        <DragAndDrop validators={{ filesFormats: ['jpg', 'jpeg', 'png'] }} renderContent={() => {
                            ...
                            return (
                                <FilesList
                                    ...
                                    closeEditingFolderName={() => this.setState({
                                        currentOpenedFolderToEditId: "",
                                        editFolderError: ""
                                    })}
...
const mapStateToProps = state => {
    return {
        ...
        oneDriveToken: state.authReducer.azureData.access_token,
