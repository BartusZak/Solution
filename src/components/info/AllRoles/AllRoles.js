...
class AllRoles extends PureComponent {
  ...
  render() {
    const { account, projects, client,assignments, certificates, clouds, cvImport, education, employees, feedbacks, gdrive, notifications, oneDrive, t } = this.props;
