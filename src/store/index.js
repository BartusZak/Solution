...
const persistConfig = {
  key: "root",
  storage,
  blacklist: ["form", "asyncReducer", "projectsReducer", "reportsReducer", "oneDriveReducer", "clientsReducer",
  "skillsReducer", "gDriveReducer", "employeesReducer", "quarterTalks", "progressBarReducer", "notificationReducer", "alertsReducer"],
  migrate: state => {
