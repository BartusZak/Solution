const translations = {
  ...
  ClientsContainer: {
    ...
    Removing: 'remove client',
    RemovingCloud: 'remove cloud',
    ReactivatingCloud: 'reactivate cloud',
    Reactivating: 'reactivate client',
  ...
  EmployeesList: {
    ...
    CheckUserProfile: 'Check user profile'
  },
  EmployeeDetails: {
    Close: 'Close',
    Edit: 'Edit',
  ...
  ProjectTeamTable: {
    ...
    AreYouSureYouWantToDeleteFeedback:
  ...
  Info: {
    ...
    GettingEmployee: 'Getting employee',
    GettingEmployeeCapacity: 'Getting employee capacity',
    GettingEmployeesAndManagers: 'Getting employees and managers',
    GettingEmployeeOnboards: 'Getting employee onboards',
    GettingEmploContact: 'Getting emplo contact',
    GettingEmploSkills: 'Getting emplo skills',
    SearchingEmployees: 'Searching employees',
    AddingEmployees: 'Adding employees',
    AddingEmployeeOnboard: 'Adding employee onboard',
    DeletingEmployeeOnboard: 'Deleting employee onboard',
    DeletingEmployee: 'Deleting employee',
    SettingEmployeeSkills: 'Setting employee skills',
    SettingEmployeeFLanguages: 'Setting foreign languages for employee',
    SettingEmployeeSkype: 'Setting skype for employee',
    EditingEmployeeOnboard: 'Editing onboard for employee',
    ReactivatingEmployee: 'Reactivating employee',

    GetFeedbackByEmployee: 'Getting employee feedbacks',
    GetFeedbackByEmployeeInProject: 'Getting employee feedbacks in project',
    AddFeedback: 'Adding feedback',
    DeleteFeedback: 'Deleting feedback',

    LoginGDrive: 'Logging to GDrive',
    GenerateShareLinkGDrive: 'Generating link to share GDrive',
    GetFoldersGDrive: 'Getting folders on GDrive',
    DeleteFolderGDrive: 'Deleting folders on GDrive',
    UpdateFolderGDrive: 'Updating folder on GDrive',
    CreateFolderGDrive: 'Creating folder on GDrive',
    UploadFolderGDrive: 'Uploading folder on GDrive',

    DeleteNotifications:'Deleting notifications',
    GetAllNotifications:'Getting all notifications',
    MarkAsReadNotification:'Marking as read Notification',

    GetRedirectLinkOneDrive: 'Getting redirect link on OneDrive ',
    SendQueryToAuthOneDrive: 'Sending query to auth on OneDrive',
    RefreshTokenOneDrive: 'Refreshing token on OneDrive',
    GenerateShareLinkOneDrive: 'Generating link to share on OneDrive',
    GetFoldersOneDrive: 'Getting folders on OneDrive',
    CreateFolderOneDrive: 'Creating folders on OneDrive',
    DeleteFolderOneDrive: 'Deleting folders on OneDrive',
    UpdateFolderOneDrive: 'Updating folders on OneDrive',
    UploadFileOneDrive: 'Uploading file to OneDrive',

    EditQuarterTalk: 'Editing quarter talk',
    GetQuarterTalkForEmployee: 'Getting quarter talk for employee',
    GetQuarterTalkReservedDates: 'Getting reserved dates for quarter talk',
    AddQuarterTalk: 'Adding quarter talk',
    PlanQuarterTalk: 'Planning quarter talk',
    AddQuestion: 'Adding question to quarter talk',
    DeleteQuestion: 'Deleting question in quarter talk',
    ReactivateQuarterTalk: 'Reactivating quarter talk',
    DeleteQuarterTalk: 'Deleting quarter talk',
    GenerateQuarterTalkDoc: 'Generating .doc file with quarter talk',
    GetQuestions: 'Getting questions',

    GenerateReport: 'Generating report',
    GenerateCv: 'Generating employee CV',
    GenerateCvWord: 'Generating employee CV in .doc',
    GetFeedback: 'Getting feedback',
    GetCv: 'Getting CV',
    GetTeams: 'Getting teams',
    GetReportExcel: 'Getting report in .xlsx',
    GetReportZip: 'Getting report in .zip',
    GetRecentReports: 'Getting recent reports',
    UnfavoriteReport: 'Unfavorite report',

    GetResponsiblePersonByClientId: 'Getting responsible person at the client',
    GetResponsiblePersonById: 'Getting responsible person',
    EditResponsiblePerson: 'Editing responsible person',
    AddResponsiblePerson: 'Adding responsible person',
    DeleteResponsiblePerson: 'Deleting responsible person',
    ReactivateResponsiblePerson: 'Reactivating responsible person',

    GetAllSkills: 'Getting all skills',
    GetSkillById: 'Getting skill',
    AddSkill: 'Adding skill',
    DeleteSkill: 'Deleting skill',
    EditSkill: 'Editing skill',

    GetStats: 'Getting stats',

    GetAllRoles: 'Getting all roles',
    AddRole: 'Adding role',
    EditRole: 'Editing role',
    DeleteRole: 'Deleting role',

    ShareProject: 'Sharing project',
    GetManagersSharedProject: 'Getting managers shared projects',
    GetAlreadySharedManagers: 'Getting already shared managers',

    AddWorkExperience: 'Adding work experience',
    GetWorkExperience: 'Getting work experience',
    EditWorkExperience: 'Editing work experience',
    DeleteWorkExperience: 'Deleting work experience',
    GetWorkExperienceByEmployeeId: 'Getting employee work experience'
  },
  ReportsCloudView: {
