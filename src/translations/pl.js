const translations = {
  ...
  ProjectDetails: {
    ...
    ProjectPhaseHasBeenAdded:
      'Faza projektu została dodana. Jesteś przekierowywany...',
    Back: 'Wróć',
    Phone: 'Nr. telefonu',
    ContactPerson: 'Wybierz lub dodaj osobę do kontaktu',
    Insert: 'Wpisz',
    ...
    EmployeeFreeCapacityAndSkills:
      'Pracownicy z wolną częścią etatu i umiejętnościami dopasowanymi do projektu',
