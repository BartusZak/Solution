...
export const GET_SHARED_EMPLOYEES_FOR_MANAGER = "GET_SHARED_EMPLOYEES_FOR_MANAGER";
export const CHANGE_SHARED_EMPLOYEES_FOR_MANAGER_STATUS = "CHANGE_SHARED_EMPLOYEES_FOR_MANAGER_STATUS";
