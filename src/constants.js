...
export const CHANGE_EMPLOYEE_FROM_CACHE = '[Employees] CHANGE_EMPLOYEE_FROM_CACHE';
export const CLEAR_EMPLOYEE_CACHING = '[Employees] CLEAR_EMPLOYEE_CACHING';
export const PUT_ONBOARDS = '[Employees] PUT_ONBOARDS';
export const PUT_EMPLOYEE_PROJECTS = '[Employees] PUT_EMPLOYEE_PROJECTS';
